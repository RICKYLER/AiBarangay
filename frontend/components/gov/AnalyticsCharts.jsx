...
export function Donut({ segments, size = 148, thickness = 18, centerLabel, centerSub, ariaLabel }) {
  // Non-finite values (undefined/NaN props) render as 0 instead of
  // poisoning the whole ring with NaN dash offsets.
  const clean = segments.map((s) => ({ ...s, value: Number.isFinite(s.value) ? s.value : 0 }));

...
/**
 * ReportLifecycle — chapter 06: the life of a report, told as a
 ...
 */
export default function ReportLifecycle() {
  ...
  return (
    <section className="pub-st-chapter lifecycle" ref={sectionRef} aria-labelledby="pub-st-lifecycle-title">
      <div className="pub-container">
        <ChapterHead
          index="06"
          eyebrow="REPORT LIFECYCLE"
          title={<>Watch a report<br />become a resolution.</>}
          sub="Keep scrolling — each stage of the lifecycle appears as the story builds, from the moment a report arrives to the moment the problem is closed."
          id="pub-st-lifecycle-title"
        />

...
import { ANNOUNCEMENTS } from '@/lib/data/publicData';
 ...
 * Cards rise in with a stagger as the section scrolls in.
 */
    ...
    <section className="pub-section" aria-labelledby="pub-news-title">
      <div className="pub-container">
        ...
        <div className="pub-news-grid">
          {items.map((item, i) => (
            <Reveal key={item.id} kind="up" delay={(i % 2) * 110} as="article" className="pub-news-card">

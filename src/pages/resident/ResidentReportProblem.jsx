...
import {
  REPORT_CATEGORIES, ZONES, RESIDENT, MY_REPORTS, nextReferenceNumber,
  TAGUM_CENTER,
} from '../../data/residentData';
...
export default function ResidentReportProblem() {
  ...
  const [zone, setZone] = useState(RESIDENT.zone);
  ...
  const addEvidence = (type) => {
    ...
    setEvidence((list) => [
      ...list,
      {
        id: `ev-${evidenceSeq}`,
        type,
        name: type === 'video' ? `evidence_video_${n}.mp4` : `evidence_photo_${n}.jpg`,
      },
    ]);
  };
    ...
    return (
      <div className="res-success res-fade">
        ...
        <div className="res-success-ref">
          ...
          <span className="res-success-ref-value">{nextReferenceNumber(MY_REPORTS)}</span>
        </div>
          ...
          <section aria-labelledby="wiz-3-title">
            ...
            <div className="res-loc-fields">
              ...
              <div className="res-field">
                ...
                <input type="text" className="res-input" value={RESIDENT.barangay} readOnly />
              </div>
            </div>
        ...
        <div className="res-wizard-nav">
          ...
          <div className="res-wizard-nav-side">
            {step < 5 ? (
              ...
              <button type="button" className="res-btn res-btn-primary res-btn-lg" onClick={submit}>
